...
// export as namespace SpotifyApiJs;
...
declare namespace SpotifyApi {
  ...
  interface SpotifyApiJs {
    ...
    isLoggedIn(
      options?: Object,
      callback?: ResultsCallback<SpotifyApi.CurrentUserIsLoggedIn>
    ): Promise<SpotifyApi.CurrentUserIsLoggedIn>;
...
/**
 * Declare SpotifyApi variable, since that is the name of the function in spotify-web-api-js.
 */
declare var SpotifyApi: SpotifyApi.SpotifyApiJsStatic;
